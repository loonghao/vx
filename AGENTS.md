...
| See all 140 providers | [`crates/vx-providers/`](crates/vx-providers/) |
...
6. **Provider count is 140** — Update any docs that reference old counts (78, 73, 70+, 50+, 105, 122, 124, 126, 129, 131, 132, 135, 136, 137, 138, 139, etc.)
...
10. **Provider count is 140** — Update any docs that reference old counts (78, 73, 70+, 50+, 105, 122, 124, 126, 129, 131, 132, 135, 136, 137, 138, 139, etc.)
...
├─────────────────────────────────────────────────────────┤
│  vx-providers/*    (140 Providers — provider.star DSL)  │
...
vx supports 140 providers across JavaScript, Python, Rust, Go, system tools, DevOps, security, cloud, .NET, C/C++, media, and more. See [`docs/tools/overview.md`](docs/tools/overview.md) for the complete list.

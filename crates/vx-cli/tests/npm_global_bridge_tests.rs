...
#[case("cargo", &["install", "--path=crates/aion-cli"])]
#[case("cargo", &["install", "--path", "crates/aion-cli", "--verbose"])]
#[case("cargo", &["install", "--git", "https://github.com/owner/repo"])]
#[case("cargo", &["install", "--git=https://github.com/owner/repo"])]
#[case("cargo", &["install", "--registry", "internal", "some-crate"])]
#[case("cargo", &["install", "--registry=internal", "some-crate"])]
#[case("cargo", &["install", "--index", "https://example.com/index", "some-crate"])]
#[case("cargo", &["install", "--index=https://example.com/index", "some-crate"])]

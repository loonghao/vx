...
#[macro_use]
mod common;
use common::{run_vx_in_dir, is_success};
...
"#,
    ...
    assert!(
        !stdout.contains("Tool '3.11' is not supported") && !stderr.contains("Tool '3.11' is not supported"),
    ...
    assert!(
        !stdout.contains("Tool '20' is not supported") && !stderr.contains("Tool '20' is not supported"),
...
"#,
    ...
    assert!(
        !stdout.contains("Tool '1.90.0' is not supported") && !stderr.contains("Tool '1.90.0' is not supported"),

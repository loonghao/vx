...
#[rstest]
#[case(Platform { os: Os::Windows, arch: Arch::X86_64 }, "2.45.0", "bin/gh.exe")]
#[case(Platform { os: Os::Linux, arch: Arch::X86_64 }, "2.44.0", "gh_2.44.0_linux_amd64/bin/gh")]
#[case(Platform { os: Os::MacOS, arch: Arch::X86_64 }, "2.43.0", "gh_2.43.0_macOS_amd64/bin/gh")]

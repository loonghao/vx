...
#[rstest]
#[case::linux_x64(Os::Linux, Arch::X86_64, "0.38.0", "x86_64-unknown-linux-musl", "tar.gz")]
#[case::linux_arm64(Os::Linux, Arch::Aarch64, "0.38.0", "aarch64-unknown-linux-musl", "tar.gz")]

...
vx is a **universal development tool manager** (v0.8.25, Rust, MIT). Users prefix any command with `vx` and tools auto-install on first use. 122 providers defined via Starlark DSL (`provider.star`).
